...
<div className="mb-5 mt-5 relative">
  ...
  <div className="mb-5 mt-5 relative">
    <input type="lastName" id="lastName" className="bg-slate-200 border border-gray-300  text-lg rounded-lg focus:ring-purple-700 focus:border-purple-700 placeholder:font-bold font-bold block w-full p-2.5 py-[0.84rem] px-8 dark:focus:ring-purple-700 dark:focus:border-purple-700  focus-visible:outline-purple-700 focus-visible:outline-1 focus-visible:outline" placeholder="Last Name" />
    {lastNameError && (
    <img src="/images/icon-error.svg" alt="" className="absolute top-2 right-0 mt-2 mr-2" />
  )}
